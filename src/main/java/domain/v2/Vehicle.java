...
public abstract class Vehicle implements Payable {
   ...
   * @param vehicleTypeCost the vehicle type tariff containing the tariffs for this type of vehicle.
   */
   ...
   *
   * @param isWithingRushHours boolean, if now is rush hour
   */
  public Integer getCost(boolean isWithingRushHours) {
   if (isWithingRushHours) {
  ...
  public String toString() {
    return "Vehicle{"
            ...
            + ", vehicleTypeTariff=" + vehicleTypeCost
            + '}';
  }
}
